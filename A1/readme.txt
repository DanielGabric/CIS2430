...
-navigate to the dgabric_a1 directory
-in the terminal type in "javac dayplanner/*.java"
-now type in "java dayplanner.DayPlanner"
-to use the program follow the prompts within the program

How to check javadocs
-go into the javadocs directory
-double click index.html, and you’re in the javadocs
...
5.Improvements
- I would add text file input output so that all the values you add don't get lost when you quit
